...
<html>
    ...
    <body>
        ...
        <form action="/caso/salvar"method="post">
            ...
            <label>CPF do cliente </label> <input type="text" name="idClienteRelacionado" required> <br>
            <label>Status</label>
            <select name="status">
            ...
            <br>
            <label>CNPJ da empresa</label><input type="text" name="idEmpresaRelacionada" required> <br>
